    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('recipes.update', $recipe) }}">
            ...
            <div class="text-center mb-4">
                ...
                >{{ old('brand', $recipe->brand) }}</textarea>
            ...
            <div class="text-center mb-4">
                ...
                <textarea
                    ...
                    class="block mx-auto px-2 py-2 w-3/4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                >{{ old('blend', $recipe->blend) }}</textarea>
            ...
            <div class="text-center mb-4">
                ...
                <textarea
                    ...
                    class="block mx-auto px-2 py-2 w-3/4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                >{{ old('roast', $recipe->roast) }}</textarea>
            ...
            <div class="text-center mb-4">
                ...
                <textarea
                    ...
                    class="block mx-auto px-2 py-2 w-3/4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                >{{ old('yield', $recipe->yield) }}</textarea>
            ...
            <div class="text-center mb-4">
                ...
                <textarea
                    ...
                    class="block mx-auto px-2 py-2 w-3/4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                >{{ old('grindsize', $recipe->grindsize) }}</textarea>
